...
class CustomRequester:
    ...
    def send_request(self, method, endpoint, data=None, expected_status=HTTPStatus.OK, need_logging=True):
        """
        Request wrapper. It allows to put in additional logic
        :param method: request method
        :param endpoint: endpoint to connect with BASE_URL
        :param data: request body. Default value is empty so that it lets in No-content requests
